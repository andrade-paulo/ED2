...
public class Hash<T> implements Serializable, Iterable<T> {
    ...
    public void inserir(int chave, T valor) {
        ...
        if (tabela[posicao] == null) {
            ...
            if (tabela[posicao].chave == chave) {
                LogDAO.addLog("[DB UPDATE] Chave " + chave + " atualizada");
            ...
            while (tabela[hashColisao(chave, i)] != null) {
                ...
                if (tabela[hashColisao(chave, i)].chave == chave) {
                    LogDAO.addLog("[DB UPDATE] Atualizando valor da chave " + chave);
            ...
            LogDAO.addLog("[DB COLLISION] Colisão na posição " + posicao + " com chave " + chave);
    ...
    public void redimensionar(int novoTamanho) {
        ...
        LogDAO.addLog("[DB RESIZE] Redimensionando tabela de " + tamanho + " para " + novoTamanho);
